...
import imagenModal1 from "./modalSlide4-1.png";
import imagenModal2 from "./modalSlide4-2.png";
import imagenModal3 from "./modalSlide4-3.png";
import "./estiloModalU3.css";
import cerrar from "../../../../../../src/assets/cerrar.png";

const modalSlide4 = ({ propModal2, open, onClose }) => {
  if (!open) return null;
